...
public interface StripMapper extends BaseMapper<Strip> {
    ...
    @Insert("insert into ${tableName} values (null,#{strip.warn},#{strip.time},#{strip.Temp},#{strip.MQ},#{strip.Socket1},#{strip.Socket2},#{strip.Socket3},#{strip.Vrms1}," +
    ...
    Strip selectNew(@Param("table") String tableName);
}